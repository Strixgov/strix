...
| Vendored verifier | `vendor/strixgov-verifier/` | The verbatim MIT-published `@strixgov/verifier@1.24.0`, so launching the verifier needs no network. |
